;(function($) {
  ...
  $(function() {
    ...
    if ($('#serviceSaleProgress').length) {
      ...
      let linearGradient =
        '<defs><linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0%" gradientUnits="userSpaceOnUse"><stop offset="20%" stop-color="#da8cff"/><stop offset="50%" stop-color="#9a55ff"/></linearGradient></defs>'
    ...
    if ($('#productSaleProgress').length) {
      ...
      bar.path.style.strokeLinecap = 'round'
      let linearGradient =
        '<defs><linearGradient id="productGradient" x1="0%" y1="0%" x2="100%" y2="0%" gradientUnits="userSpaceOnUse"><stop offset="40%" stop-color="#36d7e8"/><stop offset="70%" stop-color="#b194fa"/></linearGradient></defs>'
      bar.svg.insertAdjacentHTML('afterBegin', linearGradient)
    }
          ...
          datasets: [
            {
              ...
              borderWidth: 1,
              fill: 'origin',
              data: [20, 40, 15, 10, 25, 50, 30, 20, 50, 50, 60, 10]
            },
            {
              label: 'SYG',
              ...
              borderWidth: 1,
              fill: 'origin',
              data: [40, 30, 20, 10, 50, 15, 35, 40, 40, 15, 10, 25]
            },
            {
              label: 'YYY',
              borderColor: gradientStrokeBlue,
              ...
              borderWidth: 1,
              fill: 'origin',
              data: [70, 10, 30, 40, 25, 50, 15, 30, 40, 15, 10, 25]
            }
          ]
        },
        options: {
    ...
    if ($('#traffic-chart').length) {
      ...
      var trafficChartData = {
        ...
        // These labels appear in the legend and in the toltips when hovering different arcs
        labels: ['龚烁宇', 'SHUOYUGONG', 'SYG']
      }
